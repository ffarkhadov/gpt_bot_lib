"""
unit_day_15_fixed.py
────────────────────────────────────────────────────────────────────────────
• Колонка «Итого» удалена (роль выполняет «Прибыль»).
• Функция col_letter() генерирует буквы столбцов без пере-
  крытия имён, ошибка «'str' object is not callable» устранена.
• Формулы и индекс-карта пересчитаны под финальную схему колонок.
"""
